...
export class HomeComponent {
  ...
  premios(event: Event) {
    let premios = "1. Cocina de inducción, 4 hornillas y horno. <br>";
    premios += "2. Una cámara para vigilar tu casa. <br>";
    premios += "3. Una profilaxis profunda. <br>";
    premios += "4. Sesión fotográfica. <br>";
    premios += "5. Lecciones de violonchelo. <br>";
    premios += "6. Lecciones de guitarra. <br>";
